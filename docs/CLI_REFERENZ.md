...
rsync -avh --progress \
  ...
  "/home/mailhelper/projects/backups/KI-Mail-Helper-Dev_$(date +%Y%m%d_%H%M%S)/"
```
...
# "No module named 'src'"
export PYTHONPATH=/home/mailhelper/projects/KI-Mail-Helper-Dev
...
ls -la /home/mailhelper/projects/KI-Mail-Helper-Dev/ml_models/

# Modelle für User 1
ls -la /home/mailhelper/projects/KI-Mail-Helper-Dev/ml_models/user_1/

# Modell löschen (erzwingt Neutraining)
rm /home/mailhelper/projects/KI-Mail-Helper-Dev/ml_models/user_1/dringlichkeit_v*.pkl

# Alle Modelle löschen (Vorsicht!)
rm -rf /home/mailhelper/projects/KI-Mail-Helper-Dev/ml_models/user_*/
```
