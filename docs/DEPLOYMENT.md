...
port = http,https
filter = mail-helper
logpath = /home/mailhelper/projects/KI-Mail-Helper/logs/gunicorn_error.log
          /home/mailhelper/projects/KI-Mail-Helper/logs/gunicorn_access.log
maxretry = 5
findtime = 600
bantime = 3600
...
0 2 * * * /home/mailhelper/projects/KI-Mail-Helper/scripts/backup_database.sh

# Wöchentliches Backup um 3:00 Uhr (Sonntag)
0 3 * * 0 /home/mailhelper/projects/KI-Mail-Helper/scripts/backup_database.sh weekly
```
